...
class Record {
   ...
   * @return {Record} The record itself, in order to be able to chain calls to append().
   * @example
   * record.append(
   ...
   * @return {Record} - The record itself for chaining
   */
  delete(match) {
 ...
 * @extends Transform
 *
 * jdf djsjfh dskjhfjksd fh
 * See {@link https://nodejs.org/api/stream.html#stream_duplex_and_transform_streams}.
 */
